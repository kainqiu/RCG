<?php   
	...
	if (!get_option('simpar_appName'))
	{
		$sppsAppName = 'RCG';
		update_option('simpar_appName',$sppsAppName);
	}
	if (!get_option('simpar_appID'))
	{
		$sppsAppID = 'rOjVWE27JoaafjXS7RkuYqUIuyy7l9j0PiOQ5w55';
		update_option('simpar_appID',$sppsAppID);
	}
	if (!get_option('simpar_restApi'))
	{
		$sppsRestApi = 'UmZmXnY0suMLRrv4Zj90EnstTCZCOhWZ2s3cEOml';
...
-->
	...
	<p>
		<i>Series Name:</i>
		<select name="channel">
			<option value="announcement_Tribing">Tribing</option>
			<option value="announcement_HerosJourney">Hero's Journey</option>
			<option value="announcement_PatternsofFateandDestiny">Patterns of Fate and Destiny</option>
			<option value="announcement_Metaprogramming">Metaprogramming</option>
			<option value="announcement_Dreams">Dreams</option>
			<option value="announcement_TheWayoftheWarrior">The Way of the Warrior</option>
			<option value="announcement_SwimmingwithDolphins">Swimming with Dolphins</option>
			<option value="announcement_PositiveDeviancy">Positive Deviancy</option>
			<option value="announcement_TheEarthasaSacredText">The Earth as a Sacred Text</option>
			<option value="announcement_TheBodyofWisdom">The Body of Wisdom</option>
			<option value="announcement_AdaptiveIntelligences">Adaptive Intelligences</option>
			<option value="announcement_RadicalNLP">Radical NLP</option>
			<option value="announcement_RadicalMyth">Radical Myth</option>
			<option value="announcement_8CircuitBrainSeries">8 Circuit Brain Series</option>
			<option value="announcement_RadicalLeaders">Radical Leaders</option>
			<option value="announcement_RadicalProfit">Radical Profit</option>
			<option value="announcement_RadicalScience">Radical Science</option>
			<option value="announcement_TheAlchemyofVoice">The Alchemy of Voice</option>
			<option value="announcement_5Rhythms">5Rhythms</option>
			<option value="announcement_ParaTheatre">ParaTheatre</option>
			<option value="announcement_Other">Other</option>
		</select>
	</p>

        <input type="hidden" name="simpar_push_hidden" value="Y">  
        <p><i><?php _e("Announcement:"); ?></i> <input type="text" name="simpar_push_message" size="30"></p>
